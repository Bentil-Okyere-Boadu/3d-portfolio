...
const FeedbackCard = ({index, testimonial}: FeedBackCardProps) => {
  return (
    <motion.div variants={fadeIn('', 'spring', index*0.5, 0.5)} className="bg-black-200 p-10 rounded-3xl xs:w-[320px] w-full">
      <div className="mt-1">
        ...
        <div className="mt-7 flex justify-between items-center gap-1">
          ...
          <img className="w-10 h-10 rounded-full object-cover" src={testimonial.image} alt={`feedback by ${testimonial.name}`}/>
        </div>
      </div>
    </motion.div>
  )
  ...
  return (
    <div className="mt-12 bg-black-100 rounded-[20px]">
      ...
      >
        ...
        <div className={`mt-10 pb-14 flex flex-wrap gap-5 w-full`}>
          {
